...
public class TreinoRun extends AppCompatActivity {
    ...
    private int tempoDescanso = 20;
    private boolean estadoTreino = false;
    private boolean acabandoTempo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(TreinoRun.this, "" + treinoEscolhido, Toast.LENGTH_SHORT).show();
        ...
        object = new TextToSpeech(TreinoRun.this, new TextToSpeech.OnInitListener(){
            @Override
    ...
    public void adicionarTreino(View view){
        ...
        Toast.makeText(TreinoRun.this, "" + dataTreino, Toast.LENGTH_SHORT).show();
        ...
        Toast.makeText(TreinoRun.this, "Treino salvo ", Toast.LENGTH_SHORT).show();
