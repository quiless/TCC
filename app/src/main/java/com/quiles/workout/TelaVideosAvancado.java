...
public class TelaVideosAvancado extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        object = new TextToSpeech(TelaVideosAvancado.this, new TextToSpeech.OnInitListener() {
            @Override
    ...
    public void voltar(View view) {
        Intent intent = new Intent(TelaVideosAvancado.this, ExerciciosAvancados.class);
